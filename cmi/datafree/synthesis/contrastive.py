...
from .syn_vaccine import BackdoorSuspectLoss
...
class CMISynthesizer(BaseSynthesis):
    def __init__(self, teacher, student, generator, nz, num_classes, img_size, 
                 ...
                 normalizer=None, device='cpu', distributed=False, suspect_loss: BackdoorSuspectLoss=None):
        ...
        self.suspect_loss = suspect_loss
    ...
    def synthesize(self, targets=None):
        ...
        if self.suspect_loss is not None:
            self.total_suspect = 0
        ...
        for it in tqdm(range(self.iterations), desc='train syn'):
            ...
            if self.suspect_loss is not None:
                loss_inv = loss_inv + self.suspect_loss.loss(t_out, global_view)
                self.total_suspect += self.suspect_loss.n_shufl_penalized
            ...
            if self.suspect_loss is not None:
                ...
                self.suspect_loss.select_shuffle(global_view, t_out)
